...
def get_rank_json(base):
    ...
    js = []
    name = {}
    for y in range(2003,2019): #2016 to update
    	print y
...
if __name__ == "__main__":
    ...
    uv = 'http://cmsapi.pulselive.com/rugby/match?startDate=2015-10-12&endDate=2018-01-12&states=U,L&pageSize=10&client=pulse'
